...
== Welcome to the Bookmarks Rails Girls app!
...
* remove 'recoverable' and 'confirmable' devise options since we don't want to deal with email right now.
* remove 'recoverable'  and 'confirmable' columns and indices from migration
* rake db:migrate
* go to /users/sign_up
* run console
  > rails c
...
* require User authentication to manage Bookmarks
* order Bookmarks by descending creation date
...
* show User's bookmarks in bookmarks index page (aka myBookmarks)
